...
mysql_root_password   = "DubbDev01"   # We'll assume user "root"
...
public_folder         = "/vagrant/api/public"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "DubbVM" do |vapro|
  end
  ...
  #config.vm.synced_folder ".", "/vagrant/api",
  #          id: "dubb-apis",
  #          :nfs => true,
